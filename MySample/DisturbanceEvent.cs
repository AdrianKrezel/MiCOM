...
namespace MySample
{
    ...
    public class DisturbanceEvent
    {
        ...
        public string EventMeaning 
        { 
            get { return eventMeaning; } 
            set { eventMeaning = value; } 
        }
        public ushort ModbusAssociatedValue 
        { 
            get { return modbusAssociatedValue; } 
            set { modbusAssociatedValue = value; } 
        }
